...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/<YOUR_USERNAME>/Vietnamese_Emotion_Recognition/blob/main/Vietnamese_Emotion_Recognition.ipynb)

> Thay `<YOUR_USERNAME>` bằng GitHub username của bạn sau khi push lên.
...
Section 9  → Lưu model & push lên HuggingFace Hub
...
print(result[0])  # {'emotion': 'Enjoyment', 'prob': 0.95}
```
